...
import {
  ...
  Crown,       // Added missing import      
} from "lucide-react";
import { Link } from "react-router-dom";

const Earlychildhoodcare = () => {
      ...
      <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <div className="mb-6 inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
            ...
            <ChevronRight className="w-4 h-4" />
            <Link to="/pediatric-dentistry" className="text-sm hover:text-teal-200 transition-colors">Pediatric</Link>
            <ChevronRight className="w-4 h-4" />
            <span className="text-sm text-teal-200">Early Childhood Caries</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-teal-100 max-w-3xl mx-auto animate-fadeInUp delay-100">
            Protect Your Child's Smile from Baby Bottle Tooth Decay
          </p>
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-8 text-white/90">
            <div className="text-center">
              ...
              <div className="text-sm text-teal-200">Children Treated</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold">95%</div>
              <div className="text-sm text-teal-200">Prevention Success</div>
            </div>
            <div className="text-center">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-[2rem] shadow-[0_30px_40px_-20px_rgba(11,30,51,0.15)] p-8 md:p-12 border border-teal-200/30">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-10">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-light tracking-tight text-[#0B1E33]">
                ...
                <span className="text-sm font-normal text-gray-400 ml-2">ecc</span>
              </span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center mb-10">
            <div>
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                <span className="bg-teal-100 text-teal-700 text-xs font-medium px-3 py-1 rounded-full">nursing caries</span>
                <span className="bg-amber-100 text-amber-700 text-xs font-medium px-3 py-1 rounded-full">baby bottle decay</span>
                <span className="bg-blue-100 text-blue-700 text-xs font-medium px-3 py-1 rounded-full">preventable</span>
              </div>
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-lg leading-relaxed">
                ...
                diseases — but it's completely preventable. Learn how to protect your 
                child's teeth from baby bottle decay and establish healthy habits for life.
              </p>
              ...
              <div className="relative flex justify-center">
                ...
                <div className="relative z-10 bg-white/90 backdrop-blur-sm rounded-[1.5rem] p-8 shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] border border-teal-100">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative w-48 h-48 mb-4 flex items-center justify-center">
                      <div className="relative">
                        ...
                        <div className="absolute -right-4 top-0">
                          <div className="w-16 h-16 bg-white border-2 border-amber-400 rounded-full flex items-center justify-center relative">
                    ...
                    <h3 className="text-xl font-medium text-[#0B1E33]">baby bottle decay</h3>
                    <p className="text-sm text-gray-500">affects upper front teeth most commonly</p>
                    <div className="flex gap-2 mt-4">
                      <span className="text-xs bg-teal-100 text-teal-700 px-3 py-1 rounded-full">first visit by age 1</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                ...
                <h3 className="text-xl font-medium mb-2 text-[#0B1E33]">what is ECC?</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
                  The presence of one or more decayed, missing, or filled tooth surfaces 
                  in any primary tooth in children under 6 years old.
                </p>
              </div>

              {/* Card 2 */}
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                <Candy className="w-10 h-10 mb-4 text-teal-600 group-hover:scale-110 transition-transform" />
                ...
                <ul className="text-sm text-gray-500 leading-relaxed space-y-1 list-disc list-inside">
                  ...
                  <li>Bedtime bottle with milk/juice</li>
                  <li>Frequent sugar exposure</li>
                  <li>Poor oral hygiene</li>
                  <li>Bacterial transmission</li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                ...
                <h3 className="text-xl font-medium mb-2 text-[#0B1E33]">risk factors</h3>
                <ul className="text-sm text-gray-500 leading-relaxed space-y-1 list-disc list-inside">
                  <li>Low socioeconomic status</li>
                  <li>Frequent snacking</li>
                  <li>Enamel defects</li>
                  <li>Inadequate fluoride</li>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { sign: "white spots", desc: "early demineralization near gums", icon: Sparkles },
                { sign: "brown spots", desc: "advanced decay", icon: Droplet },
                { sign: "sensitivity", desc: "pain with hot/cold", icon: Thermometer },
                { sign: "swollen gums", desc: "inflammation", icon: Activity },
              ].map((item, index) => (
                <div key={index} className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                  ...
                  <h3 className="text-lg font-medium mb-1 text-[#0B1E33] capitalize">{item.sign}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">Wean from bottle by 12-14 months</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">Only water in bedtime bottles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">Limit sugary drinks and snacks</span>
                  </li>
                </ul>
              </div>
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">Clean gums daily before teeth appear</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">Brush twice daily with fluoride toothpaste</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">Rice-sized amount for under 3</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-teal-600 shrink-0 mt-0.5" />
                    <span className="text-sm text-gray-600">First dental visit by age 1</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-4">
                  Remineralize early white spot lesions and prevent progression.
                </p>
                <span className="text-xs text-teal-600 flex items-center gap-1 hover:gap-2 transition-all">
                  for early stages <ChevronRight className="w-3 h-3" />
                </span>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-4">
                  Tooth-colored restorations for cavities in primary teeth.
                </p>
                <span className="text-xs text-teal-600 flex items-center gap-1 hover:gap-2 transition-all">
                  for moderate decay <ChevronRight className="w-3 h-3" />
                </span>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-teal-50/50 backdrop-blur-sm rounded-[1.5rem] p-6 shadow-[0_8px_25px_-12px_rgba(11,30,51,0.1)] border border-teal-100 hover:shadow-[0_25px_40px_-16px_rgba(11,30,51,0.15)] transition-all group">
                ...
                <h3 className="text-lg font-medium mb-2 text-[#0B1E33]">crowns</h3>
                <p className="text-sm text-gray-500 leading-relaxed mb-4">
                  Stainless steel or zirconia crowns for severely decayed teeth.
                </p>
                <span className="text-xs text-teal-600 flex items-center gap-1 hover:gap-2 transition-all">
                  for advanced cases <ChevronRight className="w-3 h-3" />
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {[
                { step: "01", title: "welcome", desc: "friendly introduction", icon: Smile },
                { step: "02", title: "lap exam", desc: "knee-to-knee exam", icon: Baby },
                { step: "03", title: "count", desc: "gentle tooth count", icon: Bone }, // Fixed typo: "bone" to "tooth"
                { step: "04", title: "education", desc: "tips for parents", icon: Heart },
              ].map((item, index) => (
          ...
          <div className="mt-16 bg-gradient-to-br from-teal-600 to-teal-500 rounded-[1.5rem] p-8 text-white">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-2xl font-medium mb-2">protect your child's smile today</h3>
                <p className="text-teal-100">Early prevention is key to lifelong dental health.</p>
                <p className="text-sm text-teal-200 mt-2">✓ first visit by age 1 ✓ gentle, fun environment</p>
              </div>
            ...
            <div className="flex gap-3 items-center">
              ...
              <div>
                <p className="text-[#0B1E33] font-medium">
                  <span className="text-teal-600 font-bold">1,500+</span> children treated
                </p>
                <p className="text-xs text-gray-400">95% prevention success rate</p>
              </div>
            </div>
          ...
          <div className="text-xs text-gray-400 flex justify-between items-center mt-16">
            <span>© 2025 — Dr. Prity Raushan Dental Clinic · Early Childhood Caries</span>
...
export default Earlychildhoodcare;